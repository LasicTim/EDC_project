...
const UserEditView: React.FC = () => {
    ...
    const updateUser = async () => {
        ...
        try {
            ...
            const response = await api.post('/users/update_worker', userdata, {
                headers: {
            ...
            if (response.status === 200) {
                ...
                console.log('Updated worker successful',response.data );
            ...
            if (axios.isAxiosError(error) && error.response) {
                ...
                console.error('Updated worker failed:', error.response.data.detail);
            } else {
                console.error('Updated worker failed:', error);
            }
    ...
    return (
        <div className='userview'>
            <Card title="Urejanje podatkov">
                <div className='FormSaveButton'>
                    <Toast ref={toast}></Toast>
                    <Toast ref={updateErrorToast}></Toast>
                    <Button label="Posodobi delavca" iconPos="right" icon="pi pi-check" loading={loading} onClick={updateUser} />
                </div>
                <TabView>
