...
def summarize_by_multiplier(report_stats: list[dict]) -> dict:
    ...
    grouped = defaultdict(lambda: {
        "fill_ms": [], "export_ms": [], "compile_ms": [], "total_ms": [], "total_mem": [], "worker_count": None,
    })
...
def print_summary(summary: dict) -> None:
    header = f"{'multiplier':>10} {'workers':>8} {'avg_fill_ms':>12} {'avg_compile_ms':>16} {'avg_export_ms':>14} {'avg_total_ms':>13} {'avg_total_mem_mb':>17}"
    print(header)
    print("-" * len(header))
